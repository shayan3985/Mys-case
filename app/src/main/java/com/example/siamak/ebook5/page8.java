...
public class page8 extends Activity {
    ...
    TextView first_text_page8;
    TextView second_text_page8;
    TextView third_text_page8;
    TextView fourth_text_page8;

    LinearLayout scrollView;
    ScrollView page8_scroll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageButton_left = (ImageButton) findViewById(R.id.image_button_left_page8);
        mImageButton_right = (ImageButton) findViewById(R.id.image_button_right_page8);

        scrollView = (LinearLayout)findViewById(R.id.scroll_page8_id);
        first_text_page8= (TextView)findViewById(R.id.page8_text1);
        second_text_page8= (TextView)findViewById(R.id.page8_text2);
        third_text_page8= (TextView)findViewById(R.id.page8_text3);
        fourth_text_page8= (TextView)findViewById(R.id.page8_text4);

        page8_scroll =(ScrollView)findViewById(R.id.page8_scroll);

        imageView_j = (ImageView)findViewById(R.id.page8_image1);
        ...
        scrollView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getPointerCount()==2)
                   ...
                   /* case MotionEvent.ACTION_DOWN:
                        ...
                        case MotionEvent.ACTION_POINTER_UP:
                            Log.d("font=",first_text_page8.getTextSize()+"");
                            page8_scroll.setEnabled(true);
                            mode = NONE;
                            ...
                            if (event.getPointerCount()==2) {
                                ...
                                if (mode == DRAG) {
                                    ...
                                    if (newDist > 50) {
                                        ...
                                        Log.d("scale=", scale + "");
                                        // limit zoom
                                        final_scale = scale * first_text_page8.getTextSize();
                ...
                if (final_scale>minFont && final_scale<maxFont) {
                    ...
                    first_text_page8.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    second_text_page8.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    third_text_page8.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    fourth_text_page8.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
