...
public class page10 extends Activity {
    ...
    TextView first_text_page10;
    TextView second_text_page10;
    TextView third_text_page10;
    TextView fourth_text_page10;

    LinearLayout scrollView;
    ScrollView page10_scroll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageButton_left = (ImageButton) findViewById(R.id.image_button_left_page10);
        mImageButton_right = (ImageButton) findViewById(R.id.image_button_right_page10);

        scrollView = (LinearLayout)findViewById(R.id.scroll_page10_id);
        first_text_page10= (TextView)findViewById(R.id.page10_text1);
        second_text_page10= (TextView)findViewById(R.id.page10_text2);
        third_text_page10= (TextView)findViewById(R.id.page10_text3);
        fourth_text_page10= (TextView)findViewById(R.id.page10_text4);

        page10_scroll =(ScrollView)findViewById(R.id.page10_scroll);

        imageView_j = (ImageView)findViewById(R.id.page10_image1);
        ...
        scrollView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getPointerCount()==2)
                   ...
                   /* case MotionEvent.ACTION_DOWN:
                        ...
                        case MotionEvent.ACTION_POINTER_DOWN:
                            if (event.getPointerCount()==2) {
                                page10_scroll.setEnabled(false);
                        ...
                        case MotionEvent.ACTION_POINTER_UP:
                            Log.d("font=",first_text_page10.getTextSize()+"");
                            page10_scroll.setEnabled(true);
                            mode = NONE;
                            ...
                            if (event.getPointerCount()==2) {
                                ...
                                if (mode == DRAG) {
                                    ...
                                    if (newDist > 50) {
                                        ...
                                        Log.d("scale=", scale + "");
                                        // limit zoom
                                        final_scale = scale * first_text_page10.getTextSize();
                ...
                if (final_scale>minFont && final_scale<maxFont) {
                    ...
                    first_text_page10.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    second_text_page10.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    third_text_page10.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    fourth_text_page10.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
