...
public class page7 extends Activity {
    ...
    TextView first_text_page7;
    TextView second_text_page7;
    TextView third_text_page7;
    TextView fourth_text_page7;
    TextView fifth_text_page7;

    LinearLayout scrollView;
    ScrollView page7_scroll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageButton_left = (ImageButton) findViewById(R.id.image_button_left_page7);
        mImageButton_right = (ImageButton) findViewById(R.id.image_button_right_page7);

        scrollView = (LinearLayout)findViewById(R.id.scroll_page7_id);
        first_text_page7= (TextView)findViewById(R.id.page7_text1);
        second_text_page7= (TextView)findViewById(R.id.page7_text2);
        third_text_page7= (TextView)findViewById(R.id.page7_text3);
        fourth_text_page7= (TextView)findViewById(R.id.page7_text4);
        fifth_text_page7= (TextView)findViewById(R.id.page7_text5);

        page7_scroll =(ScrollView)findViewById(R.id.page7_scroll);

        imageView_j = (ImageView)findViewById(R.id.page7_image1);
        imageView_j.setImageResource(R.drawable.image7part1);
        imageView_jj = (ImageView)findViewById(R.id.page7_image2);
        imageView_jj.setImageResource(R.drawable.image7part2);
        imageView_jjj = (ImageView)findViewById(R.id.page7_image3);
    ...
    public void listener_setup(){
        ...
        mImageButton_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText editText= new EditText(page7.this);
        ...
        scrollView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getPointerCount()==2)
                   ...
                   /* case MotionEvent.ACTION_DOWN:
                        ...
                        case MotionEvent.ACTION_POINTER_UP:
                            Log.d("font=",first_text_page7.getTextSize()+"");
                            page7_scroll.setEnabled(true);
                            mode = NONE;
                            ...
                            if (event.getPointerCount()==2) {
                                ...
                                if (mode == DRAG) {
                                    ...
                                    if (newDist > 50) {
                                        ...
                                        Log.d("scale=", scale + "");
                                        // limit zoom
                                        final_scale = scale * first_text_page7.getTextSize();
                ...
                if (final_scale>minFont && final_scale<maxFont) {
                    ...
                    first_text_page7.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    second_text_page7.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    third_text_page7.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    fourth_text_page7.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    fifth_text_page7.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
