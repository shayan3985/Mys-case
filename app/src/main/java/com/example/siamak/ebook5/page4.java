...
public class page4 extends Activity {
    ...
    TextView first_text_page4;
    TextView second_text_page4;
    TextView third_text_page4;
    TextView fourth_text_page4;

    LinearLayout scrollView;
    ScrollView page4_scroll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageButton_left = (ImageButton) findViewById(R.id.image_button_left_page4);
        mImageButton_right = (ImageButton) findViewById(R.id.image_button_right_page4);

        scrollView = (LinearLayout)findViewById(R.id.scroll_page4_id);
        first_text_page4= (TextView)findViewById(R.id.page4_text1);
        second_text_page4= (TextView)findViewById(R.id.page4_text2);
        third_text_page4= (TextView)findViewById(R.id.page4_text3);
        fourth_text_page4= (TextView)findViewById(R.id.page4_text4);

        page4_scroll =(ScrollView)findViewById(R.id.page4_scroll);

        imageView_j = (ImageView)findViewById(R.id.page4_image1);
    ...
    public void listener_setup(){
        ...
        mImageButton_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText editText= new EditText(page4.this);
        ...
        scrollView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getPointerCount()==2)
                   ...
                   /* case MotionEvent.ACTION_DOWN:
                        ...
                        case MotionEvent.ACTION_POINTER_UP:
                            Log.d("font=",first_text_page4.getTextSize()+"");
                            page4_scroll.setEnabled(true);
                            mode = NONE;
                            ...
                            if (event.getPointerCount()==2) {
                                ...
                                if (mode == DRAG) {
                                    ...
                                    if (newDist > 50) {
                                        ...
                                        Log.d("scale=", scale + "");
                                        // limit zoom
                                        final_scale = scale * first_text_page4.getTextSize();
                ...
                if (final_scale>minFont && final_scale<maxFont) {
                    ...
                    first_text_page4.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    second_text_page4.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    third_text_page4.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    fourth_text_page4.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
