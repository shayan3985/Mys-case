...
public class page2 extends Activity {
    ...
    TextView first_text_page2;
    TextView second_text_page2;
    TextView third_text_page2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageButton_left = (ImageButton) findViewById(R.id.image_button_left_page2);
        mImageButton_right = (ImageButton) findViewById(R.id.image_button_right_page2);

        scrollView = (LinearLayout)findViewById(R.id.scroll_page2_id);
        first_text_page2= (TextView)findViewById(R.id.page2_text1);
        second_text_page2= (TextView)findViewById(R.id.page2_text2);
        third_text_page2= (TextView)findViewById(R.id.page2_text3);
        page1_scroll =(ScrollView)findViewById(R.id.page2_scroll);

        imageView_j = (ImageView)findViewById(R.id.page2_image1);
    ...
    public void listener_setup(){
        ...
        mImageButton_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText editText= new EditText(page2.this);
        ...
        scrollView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getPointerCount()==2)
                   ...
                   /* case MotionEvent.ACTION_DOWN:
                        ...
                        case MotionEvent.ACTION_POINTER_UP:
                            Log.d("font=",first_text_page2.getTextSize()+"");
                            ...
                            if (event.getPointerCount()==2) {
                                ...
                                if (mode == DRAG) {
                                    ...
                                    if (newDist > 50) {
                                        ...
                                        Log.d("scale=", scale + "");
                                        // limit zoom
                                        final_scale = scale * first_text_page2.getTextSize();
                ...
                if (final_scale>minFont && final_scale<maxFont) {
                    ...
                    first_text_page2.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    second_text_page2.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    third_text_page2.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
