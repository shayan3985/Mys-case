...
/**
 * Created by shayan on 8/7/2015.
 */
public class page3 extends Activity {
    ImageButton mImageButton_left;
    ImageButton mImageButton_right;
    TextView first_text_page3;
    TextView second_text_page3;
    TextView third_text_page3;
    TextView fourth_text_page3;

    LinearLayout scrollView;
    ScrollView page3_scroll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageButton_left = (ImageButton) findViewById(R.id.image_button_left_page3);
        mImageButton_right = (ImageButton) findViewById(R.id.image_button_right_page3);

        scrollView = (LinearLayout)findViewById(R.id.scroll_page3_id);
        first_text_page3= (TextView)findViewById(R.id.page3_text1);
        second_text_page3= (TextView)findViewById(R.id.page3_text2);
        third_text_page3= (TextView)findViewById(R.id.page3_text3);
        fourth_text_page3= (TextView)findViewById(R.id.page3_text4);

        page3_scroll =(ScrollView)findViewById(R.id.page3_scroll);

        imageView_j = (ImageView)findViewById(R.id.page3_image1);
        ...
        scrollView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getPointerCount()==2)
                   ...
                   /* case MotionEvent.ACTION_DOWN:
                        ...
                        case MotionEvent.ACTION_POINTER_UP:
                            Log.d("font=",first_text_page3.getTextSize()+"");
                            page3_scroll.setEnabled(true);
                            mode = NONE;
                            ...
                            if (event.getPointerCount()==2) {
                                ...
                                if (mode == DRAG) {
                                    ...
                                    if (newDist > 50) {
                                        ...
                                        Log.d("scale=", scale + "");
                                        // limit zoom
                                        final_scale = scale * first_text_page3.getTextSize();
                ...
                if (final_scale>minFont && final_scale<maxFont) {
                    ...
                    first_text_page3.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    second_text_page3.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    third_text_page3.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
                    fourth_text_page3.setTextSize(TypedValue.COMPLEX_UNIT_PX,final_scale);
